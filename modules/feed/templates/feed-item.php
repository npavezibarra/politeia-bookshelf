...
$note_author = $note_user_id ? get_userdata($note_user_id) : null;
$note_author_name = $note_author ? $note_author->display_name : __('User', 'politeia-reading');
...
<div class="prs-feed-card"
    ...
    <div class="prs-feed-content" id="prs-feed-content-<?php echo esc_attr($note_id); ?>">
        <div class="prs-feed-user-header" id="prs-feed-user-header-<?php echo esc_attr($note_id); ?>"
            ...
            <div id="prs-feed-user-meta-<?php echo esc_attr($note_id); ?>" style="display: flex; align-items: center; gap: 12px;">
                ...
                <?php endif; ?>
                <div id="prs-feed-user-name-<?php echo esc_attr($note_id); ?>" style="font-size: 1.05rem; font-weight: 600; color: #111;">
        ...
        <div class="prs-feed-header" id="prs-feed-header-<?php echo esc_attr($note_id); ?>"
            ...
            <div id="prs-feed-book-meta-<?php echo esc_attr($note_id); ?>" style="display: flex; gap: 1rem; align-items: flex-start; flex: 1 1 0;">
                <div class="prs-feed-cover" id="prs-feed-cover-<?php echo esc_attr($note_id); ?>" style="flex-shrink: 0;">
                ...
                <div id="prs-feed-book-text-<?php echo esc_attr($note_id); ?>">
                    <h3 id="prs-feed-book-title-<?php echo esc_attr($note_id); ?>" style="margin: 0; font-size: 1.1rem; font-weight: 600; color: #333;">
                        <?php echo esc_html($note->book_title); ?>
                    </h3>
                    <div id="prs-feed-book-author-<?php echo esc_attr($note_id); ?>" style="font-size: 0.85rem; color: #666; margin-top: 0.2rem;">
            ...
            <div class="prs-comment-form" id="prs-comment-form-<?php echo esc_attr($note_id); ?>" style="flex: 1 1 0;">
                <form class="prs-submit-comment-form" id="prs-comment-form-inner-<?php echo esc_attr($note_id); ?>" data-note-id="<?php echo (int) $note->note_id; ?>">
                    <textarea id="prs-comment-textarea-<?php echo esc_attr($note_id); ?>" name="comment_content" rows="2"
                    ...
                    <div id="prs-comment-actions-<?php echo esc_attr($note_id); ?>" style="text-align: right;">
                        <button id="prs-comment-submit-<?php echo esc_attr($note_id); ?>" type="submit" class="button button-small"
        ...
        <!-- Comments Section -->
        <div class="prs-comments-section" id="prs-comments-section-<?php echo esc_attr($note_id); ?>" style="margin-top: 1rem;">
            <div class="prs-comments-list" id="prs-comments-list-<?php echo esc_attr($note_id); ?>" style="margin-bottom: 1rem;">
                <?php foreach ($note_comments as $comment):
                    ...
                    <div class="prs-comment-item" id="prs-comment-item-<?php echo esc_attr((int) $comment->id); ?>"
                        ...
                        <div id="prs-comment-meta-<?php echo esc_attr((int) $comment->id); ?>" style="font-size: 0.85rem; font-weight: 600; color: #555; margin-bottom: 0.2rem;">
                            <span id="prs-comment-author-<?php echo esc_attr((int) $comment->id); ?>"><?php echo esc_html($author_name); ?></span>
                            <span id="prs-comment-date-<?php echo esc_attr((int) $comment->id); ?>" style="font-weight: normal; color: #999;">•
                                <?php echo esc_html($c_date); ?>
                            </span>
                        </div>
                        <div id="prs-comment-content-<?php echo esc_attr((int) $comment->id); ?>" style="font-size: 0.95rem; line-height: 1.4; color: #333;">
