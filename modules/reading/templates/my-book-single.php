                        ...
                        <table class="prs-table prs-sessions-table">
                                <thead>
                                        <tr>
                                                ...
                                                <th scope="col"><?php esc_html_e( 'Start Page', 'politeia-reading' ); ?></th>
                                                <th scope="col"><?php esc_html_e( 'End Page', 'politeia-reading' ); ?></th>
                                                <th scope="col"><?php esc_html_e( 'Total Pages', 'politeia-reading' ); ?></th>
                                ...
                                <tbody>
                                        <?php foreach ( $sessions as $i => $s ) :
                                                ...
                                                $start_page    = ( is_numeric( $s->start_page ) && (int) $s->start_page > 0 ) ? (int) $s->start_page : null;
                                                $end_page      = ( is_numeric( $s->end_page ) && (int) $s->end_page > 0 ) ? (int) $s->end_page : null;
                                                $page_diff     = null;
                                                ...
                                                <tr>
                                                        ...
                                                        <td><?php echo null !== $start_page ? esc_html( $start_page ) : '—'; ?></td>
                                                        <td><?php echo null !== $end_page ? esc_html( $end_page ) : '—'; ?></td>
                                                        <td><?php echo ( null !== $page_diff && $page_diff > 0 ) ? esc_html( $page_diff ) : '—'; ?></td>
